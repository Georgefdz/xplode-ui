...
export const buttonVariants = cva(
  [
    ...
    "font-sans text-sm font-medium tracking-[-0.005em] whitespace-nowrap",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        punch:
          "bg-punch text-punch-foreground hover:bg-punch/90 active:bg-punch",
        outline:
      ...
      size: {
        ...
        sm: "h-8 px-2.5 text-[0.8rem] has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 [&_svg:not([class*='size-'])]:size-3.5",
